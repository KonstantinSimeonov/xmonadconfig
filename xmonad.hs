...
keyBindings conf@XConfig {XMonad.modMask = modm} = M.fromList $
                ...
                , ((shiftMask .|. modm, xK_Left), spawn "xdotool mousemove_relative -- -20 0")
                , ((shiftMask .|. modm, xK_Up), spawn "xdotool mousemove_relative -- 0 -20")
                , ((shiftMask .|. modm, xK_Right), spawn "xdotool mousemove_relative -- 20 0")
                , ((shiftMask .|. modm, xK_Down), spawn "xdotool mousemove_relative -- 0 20")
                , ((altMask, xK_c), spawn "xdotool click 1")
